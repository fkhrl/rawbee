    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('contactus/list')}}">Datatable </a></li>
          ...
          <div class="card-header">
            ...
            <div class="card-tools">
              <ul class="pagination pagination-sm float-right">
                ...
                <li class="page-item">
                    <a class="page-link bg-primary" href="{{url('contactus/list')}}"> 
                        Data 
                ...
                <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <?php 
                        if(isset($dataRow->organization_name)){
                            ?>
                            value="{{$dataRow->organization_name}}" 
                            <?php 
                        }
                        ?>
                        
                        class="form-control" placeholder="Enter Organization Name" id="organization_name" name="organization_name">
                      </div>
                    </div>
                </div>
